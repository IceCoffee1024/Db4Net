...
- Typed scalar aggregate query builders through `SelectAggregateFrom<T>()`, including `Max`, `Min`, `Sum`, `Average`, `CountDistinct`, terminal result typing for `Sum` / `Average`, and `table` override overloads.
