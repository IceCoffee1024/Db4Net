...
- Typed scalar aggregate query builders through `SelectAggregateFrom<T>()`, including `Max`, `Min`, `Sum`, explicit-result `Average`, `CountDistinct`, and `table` override overloads.
