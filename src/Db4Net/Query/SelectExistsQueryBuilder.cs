...
public sealed class SelectExistsQueryBuilder<T>
{
    ...
    public SelectExistsQueryBuilder<T> When(bool condition, Action<SelectExistsQueryBuilder<T>> configure)
    {
    ...
    /// <param name="value">The value to parameterize. <see cref="Op.In"/> requires a non-string enumerable.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> WhereIf(bool condition, string propertyName, Op op, object? value)
    {
    ...
    /// <param name="op">The SQL null-check operator. Only <see cref="Op.IsNull"/> and <see cref="Op.IsNotNull"/> are supported.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> WhereIf(bool condition, string propertyName, Op op)
    {
    ...
    /// <param name="value">The value to parameterize. <see cref="Op.In"/> requires a non-string enumerable.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> WhereIf<TValue>(bool condition, Expression<Func<T, TValue>> memberSelector, Op op, object? value)
    {
    ...
    /// <param name="op">The SQL null-check operator. Only <see cref="Op.IsNull"/> and <see cref="Op.IsNotNull"/> are supported.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> WhereIf<TValue>(bool condition, Expression<Func<T, TValue>> memberSelector, Op op)
    {
    ...
    /// <param name="configure">Configures the nested filter group.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> WhereGroupIf(bool condition, Action<FilterGroupBuilder<T>> configure)
    {
        ThrowHelper.ThrowIfNull(configure);
        if (!condition)
        {
    ...
    /// <param name="value">The value to parameterize. <see cref="Op.In"/> requires a non-string enumerable.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> OrWhereIf(bool condition, string propertyName, Op op, object? value)
    {
    ...
    /// <param name="op">The SQL null-check operator. Only <see cref="Op.IsNull"/> and <see cref="Op.IsNotNull"/> are supported.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> OrWhereIf(bool condition, string propertyName, Op op)
    {
    ...
    /// <param name="value">The value to parameterize. <see cref="Op.In"/> requires a non-string enumerable.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> OrWhereIf<TValue>(bool condition, Expression<Func<T, TValue>> memberSelector, Op op, object? value)
    {
    ...
    /// <param name="op">The SQL null-check operator. Only <see cref="Op.IsNull"/> and <see cref="Op.IsNotNull"/> are supported.</param>
    /// <returns>The current query builder.</returns>
    public SelectExistsQueryBuilder<T> OrWhereIf<TValue>(bool condition, Expression<Func<T, TValue>> memberSelector, Op op)
    {
