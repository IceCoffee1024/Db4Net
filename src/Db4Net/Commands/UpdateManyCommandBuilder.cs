...
public sealed class UpdateManyCommandBuilder<T>
{
    ...
    internal UpdateManyCommandBuilder(Db4NetOptions options, IDbConnection? connection, string table, IEnumerable<T> entities, Db4NetExecutionOptions? executionOptions = null)
    {
        _options = options;
    ...
    /// <remarks>
    /// Each entity is updated in a separate statement. To ensure atomicity and avoid partial writes on failure,
