...
> This document records the initial project direction and v1 scope. It is useful for understanding why Db4Net was shaped as a SQL builder for Dapper rather than an ORM or LINQ provider. For current public API behavior, use `README.md`, `src/Db4Net/README.md`, `docs/vitepress/`, `CHANGELOG.md`, and tests as the source of truth.
