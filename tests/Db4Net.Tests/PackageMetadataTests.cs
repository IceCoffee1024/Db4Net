...
public sealed class PackageMetadataTests
{
    ...
    public void Package_metadata_contains_required_alpha_fields()
    {
        ...
        Assert.Equal("0.1.0-alpha.6", properties["Version"]);
        ...
        Assert.Equal("0.1.0-alpha.6 adds scalar ExecuteScalar terminals, BETWEEN / NOT LIKE / NOT IN filters, range-specific command filters, and MySQL 8.0.19+ row-alias upsert SQL.", properties["PackageReleaseNotes"]);
